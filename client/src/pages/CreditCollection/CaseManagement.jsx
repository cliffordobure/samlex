          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-slate-600/50">
                <th className="px-4 py-2 text-left text-xs font-semibold text-white bg-slate-700/80">Case Reference Number</th>
                <th className="px-4 py-2 text-left text-xs font-semibold text-white bg-slate-700/80">Title</th>
                <th className="px-4 py-2 text-left text-xs font-semibold text-white bg-slate-700/80">Debtor</th>
                <th className="px-4 py-2 text-left text-xs font-semibold text-white bg-slate-700/80">Amount</th>
                <th className="px-4 py-2 text-left text-xs font-semibold text-white bg-slate-700/80">Priority</th>
                <th className="px-4 py-2 text-left text-xs font-semibold text-white bg-slate-700/80">Status</th>
                <th className="px-4 py-2 text-left text-xs font-semibold text-white bg-slate-700/80">Actions</th>
              </tr>
            </thead>
            <tbody>
                ...
                >
                  <td className="px-4 py-2">
                    <Link
                      ...
                      className="inline-flex items-center space-x-2 text-blue-400 hover:text-blue-300 text-xs font-medium transition-colors duration-200"
                    >
                      <span>{case_.caseReference || "Not set"}</span>
                      <FaArrowRight className="w-3 h-3" />
                    </Link>
                  </td>
                  <td className="px-4 py-2 text-slate-300 text-xs font-medium">{case_.title}</td>
                  <td className="px-4 py-2">
                    <div className="flex items-center space-x-2">
                      <div className="w-6 h-6 bg-gradient-to-r from-blue-500/20 to-indigo-500/20 rounded-full flex items-center justify-center">
                        <FaUser className="w-3 h-3 text-blue-400" />
                      </div>
                      <span className="text-slate-300 text-xs">{case_.debtorName}</span>
                    </div>
                  </td>
                  <td className="px-4 py-2">
                    <div className="flex items-center space-x-2">
                  ...
                  <td className="px-4 py-2">
                    ...
                    case_.assignedTo?._id === user._id ? (
                      <select
                        className="px-2 py-1 bg-slate-700/80 text-white border border-slate-600/50 rounded-lg text-xs focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50 transition-all duration-200"
                        value={case_.status}
                        onChange={(e) =>
                  ...
                  <td className="px-4 py-2">
                    <div className="flex items-center space-x-2">
                      <Link
                        to={`/credit-collection/cases/${case_._id}`}
                        className="inline-flex items-center space-x-1 px-2 py-1 bg-gradient-to-r from-blue-500/20 to-indigo-500/20 hover:from-blue-500/30 hover:to-indigo-500/30 text-blue-400 rounded-lg transition-all duration-200 border border-blue-500/30 hover:border-blue-500/50"
                      >
                      ...
                      {(user?.role === "credit_head" ||
                        ...
                        <Link
                          ...
                          className="inline-flex items-center space-x-1 px-2 py-1 bg-gradient-to-r from-yellow-500/20 to-orange-500/20 hover:from-yellow-500/30 hover:to-orange-500/30 text-yellow-400 rounded-lg transition-all duration-200 border border-yellow-500/30 hover:border-yellow-500/50"
                        >
                      ...
                      {user?.role === "law_firm_admin" && onDeleteCase && (
                        <button
                          ...
                          className="inline-flex items-center space-x-1 px-2 py-1 bg-gradient-to-r from-red-500/20 to-pink-500/20 hover:from-red-500/30 hover:to-pink-500/30 text-red-400 rounded-lg transition-all duration-200 border border-red-500/30 hover:border-red-500/50"
                          title="Delete case"
                        >
